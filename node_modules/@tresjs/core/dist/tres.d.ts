...
declare function useRendererManager({
  ...
  canBeInvalidated: vue15.ComputedRef<boolean>;
  mode: "always" | "on-demand" | "manual" | undefined;
  replaceRenderFunction: (fn: RenderFunction) => void;
  isInitialized: vue15.Ref<boolean, boolean>;
  error: vue15.Ref<TresRendererError | null, TresRendererError | null>;
};
...
type DisposeType = ((self: TresInstance) => void) | boolean | 'default' | null;
...
declare const __VLS_export$2: <T extends TresObjectMap>(__VLS_props: NonNullable<Awaited<typeof __VLS_setup>>["props"], __VLS_ctx?: __VLS_PrettifyLocal<Pick<NonNullable<Awaited<typeof __VLS_setup>>, "attrs" | "emit" | "slots">>, __VLS_exposed?: NonNullable<Awaited<typeof __VLS_setup>>["expose"], __VLS_setup?: Promise<{
  props: vue15.PublicProps & __VLS_PrettifyLocal<{
    /**
  ...
  slots: {
    default?: (props: {
      state: vue15.UnwrapRef<T>;
      isLoading: boolean;
      error: unknown;
    }) => any;
  };
  emit: ((evt: "error", error: unknown) => void) & ((evt: "loaded", result: T) => void);
}>) => vue15.VNode & {
...
declare const useGraph: (object: MaybeRef$1<TresObject | undefined>) => vue15.ComputedRef<TresObjectMap | undefined>;
//#endregion
...
declare const useLoop: () => {
  stop: () => void;
  start: () => void;
  isActive: Readonly<vue15.ShallowRef<boolean>>;
...
type __VLS_Props = ContextProps & {
  canvas: HTMLCanvasElement;
};
type __VLS_Slots$1 = {
  default: () => any;
};
declare const __VLS_base$1: vue15.DefineComponent<__VLS_Props, {
  context: vue15.ShallowRef<TresContext, TresContext>;
  dispose: () => void;
}, {}, {}, {}, vue15.ComponentOptionsMixin, vue15.ComponentOptionsMixin, {
...
}, string, vue15.PublicProps, Readonly<__VLS_Props> & Readonly<{
...
declare const __VLS_base: vue15.DefineComponent<ContextProps, TresCanvasInstance, {}, {}, {}, vue15.ComponentOptionsMixin, vue15.ComponentOptionsMixin, {
  click: (event: TresPointerEvent) => any;
  contextmenu: (event: TresPointerEvent) => any;
  pointermove: (event: TresPointerEvent) => any;
  pointerenter: (event: TresPointerEvent) => any;
  ...
  beforeLoop: (context: TresContextWithClock) => any;
  loop: (context: TresContextWithClock) => any;
}, string, vue15.PublicProps, Readonly<ContextProps> & Readonly<{
  onClick?: ((event: TresPointerEvent) => any) | undefined;
  onContextmenu?: ((event: TresPointerEvent) => any) | undefined;
  onPointermove?: ((event: TresPointerEvent) => any) | undefined;
  onPointerenter?: ((event: TresPointerEvent) => any) | undefined;
 ...
 * ```
 */
declare const isLight: (value: unknown) => value is Light;
/**
